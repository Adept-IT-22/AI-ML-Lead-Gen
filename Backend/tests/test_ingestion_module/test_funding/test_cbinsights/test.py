...
# Mock the CB Insights module since it doesn't exist yet
...
async def mock_fetch_cbinsights_data():
...
from ingestion_module.funding.cbinsights import fetch

@pytest.mark.asyncio
async def test_fetch_cbinsights_data_filters_ai_links(monkeypatch):
    # Mocked sitemap XML with AI and non-AI links
    xml = """
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
            xmlns:n="http://www.google.com/schemas/sitemap-news/0.9">
        <url><loc>https://www.cbinsights.com/ai-funding-2023.html</loc></url>
        <url><loc>https://www.cbinsights.com/ai-raises-2023.html</loc></url>
        <url><loc>https://www.cbinsights.com/other-news.html</loc></url>
    </urlset>
    """
    ...
    results = await fetch.fetch_cbinsights_data()
    assert "https://www.cbinsights.com/ai-funding-2023.html" in results["urls"]
    assert "https://www.cbinsights.com/ai-raises-2023.html" in results["urls"]
    assert "https://www.cbinsights.com/other-news.html" not in results["urls"]
