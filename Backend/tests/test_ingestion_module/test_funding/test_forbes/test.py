...
from ingestion_module.funding.forbes import fetch as fetch_mod
...
# Test that parse_sitemap extracts URLs with publication dates
@pytest.mark.asyncio
async def test_parse_sitemap_extracts_urls():
    # Simulate Forbes news sitemap XML with article URLs
    xml = """
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:news="http://www.google.com/schemas/sitemap-news/0.9">
        <url>
            <loc>https://www.forbes.com/sites/tech/2025/11/05/article1.html</loc>
            <lastmod>2025-11-05T11:50:33Z</lastmod>
            <news:news>
                <news:publication_date>2025-11-05T11:50:12Z</news:publication_date>
            </news:news>
        </url>
        <url>
            <loc>https://www.forbes.com/sites/tech/2025/10/09/article2.html</loc>
    ...
    assert "https://www.forbes.com/sites/tech/2025/11/05/article1.html" in urls
    assert "https://www.forbes.com/sites/tech/2025/10/09/article2.html" in urls
    
    # Check publication dates are included
    assert len(articles) == 2
    assert articles[0]['lastmod'] == "2025-11-05T11:50:12Z"  # Uses publication_date
    assert articles[1]['lastmod'] == "2025-10-09T22:09:00Z"  # Uses publication_date
...
# Test that extract_and_filter_paragraphs extracts paragraphs from article-body
@pytest.mark.asyncio
async def test_extract_and_filter_paragraphs_returns_paragraphs():
    ...
    <html>
        ...
        <body>
            ...
            <div class="fs-article fs-responsive-text current-article article-body">
